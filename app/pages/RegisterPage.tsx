            ...
            <LinearGradient
                ...
                <View style={styles.main} >
                    ...
                    <View style={styles.logincont}>
                        <Text className=' text-white text-4xl font-bold mb-4 sha'>Registrarse</Text>
                        <View>
                        ...
                        <TouchableOpacity className=' bg-violet-700 w-40 flex justify-center items-center rounded-lg mt-4' onPress={handleLoginOrRegister} >
                            <Text style={styles.label} className=' text-white text-4xl font-bold mb-4'>Registrarse</Text>
                        </TouchableOpacity>
                        ...
                        <View className=' flex flex-row mt-14'>
                            ...
                            <TouchableOpacity id='cambiarRegistro' onPress={() => navigation.navigate("Login") }>
                                <Text className=' text-violet-700'>Inicia Sesión</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
